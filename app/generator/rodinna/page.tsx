...
export default function RodinnaGenerator() {
  ...
  async function handleGenerate() {
    ...
    setGenerating(true);
    await consumeCredits("guest", 3);
    // Simulate generation
    setTimeout(() => {
      setResultUrl("/placeholder/rodinna.jpg");
      setOpen(true);
      setGenerating(false);
    }, 1000);
  }
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-semibold">Rodinná proměna</h1>
      <p className="opacity-90">Zde bude váš vlastní layout/UI (vložíte později). Níže je pouze skeleton funkcí.</p>
          ...
          <div className="bg-black/60 backdrop-blur rounded-xl border border-white/10 p-4 max-w-3xl w-full">
            ...
            <div className="mt-4 flex justify-end">
              <a
                href={resultUrl}
                download
                className="inline-flex items-center rounded-md bg-emerald-500/80 px-3 py-1.5 hover:bg-emerald-400/90"
              >
                Stáhnout
              </a>
            </div>
